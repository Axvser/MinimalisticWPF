...
namespace MinimalisticWPF
{
    ...
    /// <param name="CanInvokeRelease">Select whether to notify the object pool of attempting to recycle elements when the Setter triggers</param>
    /// <param name="Cascades">Changes to this property are shared with other properties</param>
    [AttributeUsage(AttributeTargets.Field, AllowMultiple = false, Inherited = true)]
    public class ObservableAttribute(SetterValidations SetterValidation = SetterValidations.Compare, bool CanOverride = false, bool CanHover = false, bool CanInvokeRelease = false, params string[] Cascades) : Attribute
    {
        ...
        public bool CanInvokeRelease { get; private set; } = CanInvokeRelease;
