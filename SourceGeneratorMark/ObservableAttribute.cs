namespace MinimalisticWPF
{
    ...
    public class ObservableAttribute(SetterValidations SetterValidation = SetterValidations.Compare, bool CanOverride = false, bool CanHover = false, bool CanDependency = false, params string[] Cascades) : Attribute
    {
