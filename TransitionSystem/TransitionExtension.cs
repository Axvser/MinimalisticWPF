...
public static class TransitionExtension
{
    ...
    {
        var result = global::Transition.Compile([transfer], transfer.TransitionParams, source);
        result.Start();
        return result;
    }
    ...
    {
        global::Transition.Dispose(source);
        var param = new TransitionParams();
        set.Invoke(param);
        var result = global::Transition.Compile([state], param, source);
        result.Start();
        return result;
