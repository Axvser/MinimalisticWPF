...
/// <para>Core</para>
/// <para>- ( Async ) <see cref="StringCatcher.Between"/></para>
/// <para>- ( Async ) <see cref="StringCatcher.Like"/></para>
/// <para>- ( Async ) <see cref="StringCatcher.Hierarchical"/></para>
/// <para>- ( Async ) <see cref="StringCatcher.Numbers"/></para>
/// <para>- ( Async ) <see cref="StringCatcher.Words"/></para>
/// <para>- ( Async ) <see cref="StringCatcher.Chinese"/></para>
/// </summary>
